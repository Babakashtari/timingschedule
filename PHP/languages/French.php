...
if(isset($_SESSION['language']) && $_SESSION['language'] === "FR"){
    $translation = [
        ...
        "ignore_activation_message" => "Si vous ne vous êtes pas enregistré(e) dans notre site, ignorez ce message tout simplement.",
        "activation_request" => "Sinon vous pouvez trouver le lien d'activation ci-dessous:",
        "letter_ending" => "Sincèrement à vous,",
        "signature" => "Equipe de Timing Schedule",
        "registration_appreciation" => "Merci de votre inscription.",
        "activation_confirmation" => "Votre compte est désormais activé et vous pouvez entrer ci-dessous:",
        "incorrect_token_error" => "Code inséré n'était pas correcte.",
        ...
        "return" => "Retour",
        "delete_notification_text" => "Supprimer ce compte?",
        "delete_confirm_message" => "En êtes sûr ?",
