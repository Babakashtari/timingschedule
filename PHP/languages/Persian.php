...
if(isset($_SESSION['language']) && $_SESSION['language'] === "FA"){
    $translation = [
        ...
        "ignore_activation_message" => "اگر در سایت ما ثبت نام نکرده اید، این پیام را نادیده بگیرید.",
        "activation_request" => "در غیر این صورت می توانید از طریق لینک زیر کاربری خود را فعال کنید:",
        "letter_ending" => "ضمن تشکر بابت ثبت نام در سایت ما,",
        "signature" => "تیم پشتیبانی برنامه و زمان بندی",
        "registration_appreciation" => "ممنون که سایت ما را انتخاب کرده اید.",
        "activation_confirmation" => "کاربری شما فعال شد. می توانید از منوی زیر وارد سایت شوید:",
        "incorrect_token_error" => "کد وارده صحیح نمی باشد.",
        ...
        "return" => "بازگشت",
        "delete_notification_text" => "حذف حساب بانکی؟",
        "delete_confirm_message" => "اطمینان دارید؟",
