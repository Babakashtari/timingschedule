        ...
        if ($connection->connect_error) {
            ...
            if(!empty($_POST['account_number'])){
                ...
                if(empty($account_number)){
                    ...
                    // checking if the same account number exists in the database:
...
if(isset($_POST['Iranian_bank_account']) && $_POST['Iranian_bank_account'] === "Iranian_bank_account_submit"){
    ...
    $add_new_Iranian_bank_account->check_if_data_is_already_present_in_database();
    $add_new_Iranian_bank_account->adding_bank_account();
}
?>